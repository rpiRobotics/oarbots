            ...
            <main>
                <div className="flex flex-col justify-center items-center w-screen py-24 bg-gray-100 dark:bg-gray-800">
                    ...
                    <div className="flex flex-row justify-center items-center gap-4">
                        <Link className="hover:no-underline text-2xl bg-blue-300 dark:bg-blue-900 hover:bg-blue-400 hover:dark:bg-blue-800 px-6 py-2 text-black dark:text-white rounded-xl font-semibold transition hover:-translate-y-0.5 hover:drop-shadow-md" to="/docs/getting-started/hardware-overview">
                            View the Docs
                        </Link>
