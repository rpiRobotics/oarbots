...
Additionally, because virtual machines tend to have complex network setups, you will likely need to perform the instructions in [Common Issue: Switching Networks & Multi-Network Setups](personal-device-setup.mdx#common-issue-switching-networks--multi-network-setups).
